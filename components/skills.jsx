...
export default function Skills() {
  return (
    <div id="skills" className="lg:w-full bg-[#f5f5f5] py-20">
      <div className="max-w-7xl mx-auto p-2 flex flex-col justify-center h-full">
        <p className="uppercase flex justify-center text-3xl text-bold tracking-widest text-[#090c14] py-20">
          Skills
        </p>

        <div className="p-2 flex  flex-row shadow-lg hover:scale-105 py-20">
