    ...
    <div className="w-full md:screen p-2 flex items-center py-10">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2 max-w-lg mx-auto">
          <p1 className="uppercase flex justify-center text-xl tracking-widest text-[#090c14]">About</p1>
          <p className="py-4 text-gray-600   m-auto text-xl">I am interested in developing efficient and user-centric projects.
