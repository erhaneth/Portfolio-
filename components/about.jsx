...
export default function About() {
  return (
    ...
    <div className="w-full md:screen p-2 flex items-center py-96">
      <div className="max-w-[1240px] m-auto md:grid grid-cols-3 gap-8">
        <div className="col-span-2">
          <p1 className="uppercase text-xl tracking-widest text-[#090c14]">About</p1>
          <p className="py-4 text-gray-500 max-w-[%35] m-auto">I am interested in developing efficient and user-centric projects.
            ...
            technology and motivated to make it broadly accessible and utilized.</p>
        </div>
